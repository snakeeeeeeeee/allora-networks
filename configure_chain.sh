...
yes | allorad  tx emissions  request-inference $WHITELISTED_ADDRESS  '{"nonce": "1","topic_id":"1","cadence":"60","max_price_per_inference":"1","bid_amount":"10000","timestamp_valid_until":"1711218625"}' --node=$NODE_RPC_URL
...
yes | allorad  tx emissions  request-inference $WHITELISTED_ADDRESS  '{"nonce": "2","topic_id":"2","cadence":"60","max_price_per_inference":"1","bid_amount":"10000","timestamp_valid_until":"1711218625"}' --node=$NODE_RPC_URL
...
yes | allorad  tx emissions  request-inference $WHITELISTED_ADDRESS  '{"nonce": "3","topic_id":"3","cadence":"60","max_price_per_inference":"1","bid_amount":"10000","timestamp_valid_until":"1711218625"}' --node=$NODE_RPC_URL
